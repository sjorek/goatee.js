...
root.Javascript = class Javascript
  ...
  evaluateToRules: (expressions, _rules) ->
    ...
    evaluate  = @evaluateToFunction
    result    = []
    _rules.each (key, value, priority) ->
      result.push(key, evaluate value)
    return result
...
# @type {goatee.Action.Compiler.Javascript}
_instance = Javascript.instance = null

##
# Singleton implementation
# @return {goatee.Action.Compiler.Javascript}
Javascript.get = () ->
