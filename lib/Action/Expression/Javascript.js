...
(function() {
  var Javascript, STRING_data, STRING_variables, STRING_with, exports, parse, trim, _instance, _ref, _ref1;
  ...
  exports.Javascript = Javascript = (function() {
    ...
    Javascript.prototype.evaluateToFunctions = function(expressions) {
      var colon, expression, key, result, value, _i, _len, _ref2;
      result = [];
      _ref2 = expressions.split(Constants.REGEXP_semicolon);
    ...
    Javascript.prototype.evaluateToClosures = function(expressions) {
      var expression, _i, _len, _ref2, _results;
      _ref2 = expressions.split(Constants.REGEXP_semicolon);
      _results = [];
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        expression = _ref2[_i];
