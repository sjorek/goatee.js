...
(function() {
  ...
  root.Expression = Expression = (function() {
    var _booleanize, _errors, _evaluate, _execute, _global, _interpretate, _isArray, _isExpression, _isFunction, _isNumber, _isProperty, _isString, _operations, _operator, _parse, _parser, _process, _scope, _stack, _stringify, _toString, _variables;
    ...
    Expression.compress = function(code) {
      return _parse(code).toString();
    };

    Expression.compile = function(code, compress) {
      return _parse(code).compile(compress);
    };
    ...
    Expression.prototype.compile = function(compress) {
      ...
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        parameter = _ref1[_i];
        opcode.push(_isExpression(parameter) ? parameter.compile(compress) : parameter);
      }
      return opcode;
    };
