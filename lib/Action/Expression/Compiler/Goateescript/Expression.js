...
(function() {
  var Expression, Expression_contextStack, Expression_currentExpression, Expression_errors, Expression_evaluate, Expression_expressionStack, Expression_global, Expression_parentExpression, Expression_variables, evaluateInternal, global, isDotExpressionRight, isExpression, key, operations, root, toBoolean, toString, value, _, _ref, _ref1;
  ...
  root.Expression = (global.goatee != null ? global.goatee : global.goatee = {}).Expression = Expression = (function() {
    function Expression(op, params) {
      ...
      if (this.vector === void 0) {
        ...
        for (_j = 0, _len1 = params.length; _j < _len1; _j++) {
          param = params[_j];
          if (isExpression(param) && param.vector) {
            this.vector = true;
            break;
          }
        }
    ...
    Expression.prototype.evaluate = function(context) {
      return Expression_evaluate(context, this);
    };
  ...
  operations = {
    '=': {
      evaluate: function(a, b) {
        return Expression_variables[a] = b;
      }
    },
    '.': {
      chain: true,
    ...
    '?:': {
      ...
      evaluate: function(a, b, c) {
        a = Expression_evaluate(this, a);
        if (toBoolean(a)) {
          return Expression_evaluate(this, b);
        } else {
          return Expression_evaluate(this, c);
        }
      }
    },
    '()': {
    ...
    "for": {
      ...
      evaluate: function(a, b) {
        ...
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          value = _ref2[_i];
          _results.push(Expression_evaluate(value, b));
        }
        return _results;
      }
    },
  ...
  Expression_currentExpression = function() {
    return Expression_expressionStack != null ? Expression_expressionStack[Expression_expressionStack.length - 1] : void 0;
  };

  Expression_parentExpression = function() {
    return Expression_expressionStack != null ? Expression_expressionStack[Expression_expressionStack.length - 2] : void 0;
  };

  isDotExpressionRight = function() {
    var p;
    p = Expression_parentExpression();
    return (p != null) && p.operator.name === '.' && p.parameters[1] === Expression_currentExpression();
  };

  Expression_evaluate = function(context, expression) {
    ...
    isGlobalScope = Expression_global === void 0;
    if (isGlobalScope) {
    ...
    try {
      ...
      e = _error;
      (Expression_errors != null ? Expression_errors : Expression_errors = []).push(e);
    } finally {
      if (isGlobalScope) {
        Expression_global = void 0;
      }
  ...
  evaluateInternal = function(context, expression) {
    var e, left, leftValue, op, p, params, right, rightValue, values, _i, _len;
