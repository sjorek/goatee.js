...
(function() {
  var Expression, Stack, global, isArray, isExpression, isFunction, isNumber, isString, root, toString, _ref, _ref1,
    __slice = [].slice;
  ...
  _ref = require('./Utility').Utility, toString = _ref.toString, isString = _ref.isString, isArray = _ref.isArray, isNumber = _ref.isNumber, isFunction = _ref.isFunction, isExpression = _ref.isExpression;

  root = (_ref1 = typeof module !== "undefined" && module !== null ? module.exports : void 0) != null ? _ref1 : this;

  root.Expression = Expression = (function() {
    var _booleanize, _errors, _evaluate, _execute, _global, _isProperty, _operations, _operator, _parser, _process, _scope, _stack, _stringify, _variables;
