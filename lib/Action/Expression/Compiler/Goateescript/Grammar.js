...
(function() {
  var $1, $2, $3, $4, $5, $6, $7, $8, Grammar, Parser, bop, o, r, root, unwrap, yy, _ref,
  ...
  root.Grammar = Grammar = {
    ...
    operators: [['left', '.', '[', ']'], ['left', '(', ')'], ['right', '!'], ['left', '*', '/', '%'], ['left', '+', '-'], ['left', '<=', '>=', '<', '>'], ['left', '===', '!==', '==', '!='], ['left', '&&'], ['left', '||'], ['right', '?', ':'], ['left', '*=', '/=', '%='], ['left', '+=', '-='], ['left', '&=', '^=', '|='], ['left', '>>>=', '>>=', '<<='], ['left', '='], ['left', ',']].reverse(),
    startSymbol: 'Root',
    bnf: {
      Root: [
        r('EOF', function() {
      ...
      Statement: [
        o(';', function() {
          return yy.Empty;
        }), o('Expression'), o('Conditional'), o('Assignment')
      ],
      EmptyStatement: [
        o(';', function() {
          return yy.Empty;
