...
(function() {
  var NativeJavascript, constants, instance, root, utility;
  ...
  */
  ...
  root.NativeJavascript = NativeJavascript = (function() {
    var evaluateToSelf, _evaluateToFunctionCache;

    function NativeJavascript() {}

    NativeJavascript.prototype.evaluateExpression = function(expression) {
      var e;
      try {
        /*
    ...
    NativeJavascript.prototype.evaluateToFunction = function(expression) {
      var e;
    ...
    NativeJavascript.prototype.evaluateToFunctions = function(expressions) {
    ...
    NativeJavascript.prototype.evaluateToClosures = function(expressions) {
    ...
    return NativeJavascript;

  })();

  NativeJavascript.instance = instance = null;

  NativeJavascript.get = function() {
    return instance != null ? instance : (instance = new NativeJavascript);
  };
